  ...
  menopause: {
    ...
    understanding: [
      { label: "Perimenopause", tone: "peach", body: [
        ...
        "Hormones — especially estrogen and progesterone — fluctuate unpredictably during perimenopause. Estrogen doesn't simply drop; it spikes and crashes, sometimes dramatically, while progesterone trends downward. These swings drive most of the symptoms, and they can vary wildly month to month.",
        "Common signs include irregular cycles (shorter, longer, heavier, lighter), sleep issues (especially waking at 3am), mood swings, anxiety that feels new or worse, brain fog, joint aches, weight shifts (often around the middle), hot flashes, night sweats, lower libido, vaginal dryness, and changes in skin and hair.",
        "Less-known but extremely common signs include heart palpitations, tinnitus, frozen shoulder, dry eyes, itchy skin, gum changes, increased migraines, urinary urgency, and sudden histamine sensitivity. If you're collecting strange new symptoms in your 40s, perimenopause is often the missing thread.",
        "Many people are told they're 'too young' for perimenopause when symptoms appear in their late 30s. They aren't. Early perimenopause is real, often missed, and often dismissed — sometimes for years before anyone names it.",
        "Mental health shifts are common and underdiscussed. Rates of depression and anxiety rise sharply during perimenopause, and the cause is often hormonal rather than circumstantial. Treating it as 'just stress' misses an effective opportunity for relief.",
        "Perimenopause is highly treatable. Hormone therapy (when appropriate) is one of the most effective tools we have; non-hormonal medications, lifestyle adjustments, and pelvic care all help. Suffering through is a choice, not a requirement.",
        "Find a clinician who actually understands perimenopause. Many doctors received minimal training in it, and the difference between an informed clinician and an uninformed one is enormous. The Menopause Society directory is a useful starting point.",
        "It isn't a decline — it's a transition. With the right support, many people emerge from perimenopause with a clearer sense of what they want, sharper boundaries, and a different relationship with their body and their time."
      ]},
      { label: "Menopause", tone: "blue", body: [
        "Menopause is officially the single day you've gone 12 full months without a period. Everything before is perimenopause; everything after is postmenopause. The average age is around 51, with a normal range from 45 to 55. Before 40 is premature menopause; 40–45 is early menopause.",
        "Menopause can also be induced — by surgery (removal of both ovaries), chemotherapy, radiation, or certain medications. Surgical menopause is often more abrupt and intense because the hormonal drop is immediate rather than gradual, and usually deserves proactive treatment.",
        "Estrogen has receptors almost everywhere in the body — brain, heart, bones, joints, skin, gut, bladder, vagina, blood vessels. When estrogen drops, the effects are felt almost everywhere too, which is why menopause symptoms can seem to come from completely unrelated systems.",
        "Symptoms include hot flashes, night sweats, vaginal dryness, painful sex, sleep changes, mood shifts, anxiety, brain fog, joint pain, skin changes, hair thinning, weight redistribution, urinary urgency, recurrent UTIs, and reduced libido. Symptoms vary enormously — some people sail through, others struggle for years.",
        "Menopause also brings longer-term changes — accelerated bone loss in the first 5–7 years (raising osteoporosis risk), increased cardiovascular risk (heart disease becomes the leading cause of death in women postmenopause), body composition shifts, and changes in cognitive function for some.",
        "The good news: most of these long-term risks respond to action. Strength training protects bones and muscle. Mediterranean-style eating and exercise protect the heart. Sleep, social connection, and cognitive engagement protect the brain.",
        "Treatment options include hormone therapy (HRT/MHT), non-hormonal medications (certain SSRIs, gabapentin, oxybutynin for hot flashes; newer options like fezolinetant), vaginal estrogen for genitourinary symptoms (very low risk, very high reward), and meaningful lifestyle changes.",
        "Hormone therapy has been badly misunderstood since the early 2000s. For most healthy people within 10 years of menopause and under 60, the benefits outweigh the risks — and the risks are smaller than the original headlines suggested. Vaginal estrogen is safe for almost everyone.",
        "Cultural narratives about menopause have done damage. The idea that it's the end of vitality, attractiveness, or relevance is wrong, and increasingly being challenged. Many people describe their postmenopausal years as some of the most powerful of their lives.",
        "There's no one-size-fits-all menopause plan — only the plan that fits you, your body, your history, your values, and your goals. A good clinician helps you build that plan, not hand you a generic one."
      ]},
      { label: "Postmenopause", tone: "rose", body: [
        "Postmenopause begins after that 12-month mark without a period and lasts the rest of your life — which, for many women, is now 30 to 40 years. It's not a footnote; it's a major chapter, and it deserves real planning.",
        "Many disruptive symptoms ease over time. Hot flashes, night sweats, and mood swings often calm down within a few years for most people. Some, like vaginal dryness, painful sex, and urinary symptoms, can linger or worsen and benefit from ongoing care (vaginal estrogen is highly effective).",
        "Focus shifts to long-term health: bones (osteoporosis prevention), heart (cardiovascular risk now equals or exceeds men's), brain (cognition, dementia risk), muscle (sarcopenia), and metabolism (insulin sensitivity, body composition). The work done now compounds for decades.",
        "Strength training becomes one of the most important habits in life — not optional, not a 'nice to have.' Two to three sessions a week protects bone density, muscle mass, balance, metabolic health, and independence into old age.",
        "Nutrition needs shift — more protein (often 1.2–1.6g per kg body weight daily), adequate calcium (1200mg/day, ideally from food), vitamin D, fiber, omega-3s, and a Mediterranean-style pattern. Alcohol becomes harder on sleep, mood, and bones.",
        "Genitourinary syndrome of menopause (GSM) — vaginal dryness, painful sex, urinary urgency, recurrent UTIs — affects most postmenopausal women but is consistently undertreated. Vaginal estrogen, moisturizers, and pelvic floor physiotherapy can be life-changing.",
        "Bone density screening (DEXA scan) becomes important, typically starting around 65 (or earlier with risk factors). Cardiovascular check-ins (blood pressure, lipids, glucose), regular cancer screenings, and skin checks should stay on the calendar.",
        "Mental health continues to need attention. Rates of depression often improve postmenopause, but loneliness, grief (parents, partners, friends), and identity changes can hit hard. Therapy, community, and purposeful engagement matter.",
        "Sexual health doesn't end — it changes. Many people report better, more connected, more honest sex postmenopause, especially when GSM is treated. Desire, arousal, and pleasure are all still very much possible.",
        "Many describe postmenopause as a powerful chapter — clearer priorities, more freedom from cycles and contraception, less tolerance for what doesn't matter, deeper friendships, and a kind of grounded confidence that didn't exist before."
      ]},
      { label: "Menopause Relief", tone: "mint", body: [
        "Start with the basics — cool bedroom (around 65°F/18°C), less alcohol and caffeine (especially in the afternoon), a steady wind-down ritual, dressing in layers, breathable bedding, and a cold glass of water by the bed for night sweats.",
        "Lift weights twice a week. Strength training is one of the most effective interventions for menopause — it improves bone density, muscle mass, sleep, mood, insulin sensitivity, and even hot flashes. Bodyweight, bands, or weights all count.",
        "Eat to support this stage — steady protein at every meal (25–35g), fiber from a variety of plants, healthy fats, calcium-rich foods, and adequate vitamin D. Reduce ultra-processed foods and refined sugar, which worsen hot flashes and energy crashes.",
        "Movement matters more than ever — strength training, walking (especially after meals), flexibility work, and balance training. Even 10–20 minutes daily makes a meaningful difference.",
        "Hormone therapy (HRT/MHT) is the most effective treatment for hot flashes, night sweats, sleep, mood, and genitourinary symptoms — and it also protects bones. Modern HRT (transdermal estradiol with micronized progesterone) is far safer than older formulations and worth a serious conversation with an informed clinician.",
        "Non-hormonal options exist for those who can't or don't want HRT: certain SSRIs/SNRIs (especially paroxetine, venlafaxine), gabapentin, oxybutynin, clonidine, and the newer fezolinetant for hot flashes. CBT for hot flashes is also surprisingly effective.",
        "For genitourinary symptoms, vaginal estrogen is often life-changing — and it's safe for almost everyone, including most cancer survivors (with their oncologist's input). Vaginal moisturizers and lubricants help too. Don't suffer in silence here.",
        "Sleep often takes the biggest hit. Treat it as medical — cool room, no alcohol, screens off early, magnesium glycinate, and address night sweats directly. If sleep stays bad, sleep apnea risk rises postmenopause and is worth screening for.",
        "Mental health support during the transition is wise, not weakness. Therapy, community, and sometimes medication can make a year of perimenopause much easier than white-knuckling it.",
        "Build a small care team you trust — an informed primary care doctor, a menopause-literate gynecologist or specialist, possibly a pelvic floor physiotherapist, a dietitian, and a therapist. The right team turns this chapter from something endured into something navigated."
      ]},
    ],
    articles: [
      {
