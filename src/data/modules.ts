  ...
  pcos: {
    ...
    understanding: [
      { label: "Basic Guide", tone: "peach", body: [
        ...
        "Underneath these visible signs, there are usually two quieter drivers: insulin resistance and chronic low-grade inflammation. Insulin resistance means your body has to make more insulin than usual to keep blood sugar steady, and that extra insulin nudges the ovaries to make more androgens. Inflammation amplifies the whole loop.",
        "PCOS isn't just a 'period problem.' Because hormones touch every system, it can also affect mood, energy, skin, hair, weight distribution, sleep, fertility, and long-term metabolic health.",
        "The encouraging part is that PCOS is highly responsive to lifestyle. Steady meals built around protein and fiber, two or three short strength sessions a week, consistent sleep, and small daily stress outlets can ease most symptoms — sometimes within just a few cycles.",
        "There's also no single 'PCOS diet' or 'PCOS workout' that fits everyone. The best plan is the one you can actually keep: foods you enjoy, movement you don't dread, and a routine that respects the rest of your life.",
        "If you suspect PCOS, ask for a proper workup: a hormone panel, fasting insulin and glucose, a thyroid check, and a pelvic ultrasound. Naming what's happening is the first relief — and the doorway to a plan that actually fits you."
      ]},
      { label: "PCOS Made Simple", tone: "blue", body: [
        "If PCOS feels confusing, think of it as a communication issue between three players: your brain, your ovaries, and your insulin system. None of these parts is broken; they're just out of sync.",
        "When you eat, your body releases insulin to move sugar from blood into cells. In PCOS, cells respond more slowly, so the body releases extra insulin. That extra insulin signals the ovaries to make more androgens, which disrupts ovulation. No ovulation means irregular cycles, which feeds back into more imbalance.",
        "This is why PCOS symptoms cluster the way they do. Acne, oily skin, hair changes, and irregular periods all trace back to the same hormonal current — one underlying pattern showing up in different places.",
        "Stress and sleep are part of the loop too. Short or broken sleep raises cortisol, which raises insulin, which pushes androgens higher.",
        "The simplest interventions work because they calm the whole loop at once: protein at every meal, a 10-minute walk after eating, lifting weights, and 7–9 hours of sleep.",
        "You don't need to do all of this perfectly. Even one or two of these habits, repeated most days, gently quiets the system.",
        "Think of PCOS management less as a strict protocol and more as a long, kind conversation with your body."
      ]},
      { label: "What is PCOS?", tone: "rose", body: [
        "PCOS is a lifelong endocrine condition in which the ovaries don't release eggs as regularly as they should. It usually shows up in the late teens or twenties, but many people aren't diagnosed until much later.",
        "Symptoms vary enormously. The most common include missed or unpredictable periods, acne, oily skin, hair thinning, hair growth on the face or body, weight that's hard to shift around the middle, low energy, anxiety, and mood changes.",
        "Diagnosis follows the Rotterdam criteria: irregular ovulation, signs of high androgens, and polycystic-looking ovaries on ultrasound. Two out of three is enough.",
        "There are several recognized 'types' — insulin-resistant, inflammatory, post-pill, and adrenal — and many people overlap more than one.",
        "PCOS is linked to higher risk of type 2 diabetes, high blood pressure, fatty liver, sleep apnea, and certain mood conditions. None are guaranteed, but knowing the risks means you can stay ahead of them.",
        "PCOS is not your fault. It runs in families and is shaped by a mix of genetics, environment, and hormones — most of which you didn't choose.",
      ...
      { label: "Life Changing Tips", tone: "mint", body: [
        "Start with the plate. Build meals around protein, then add fiber, then add healthy fats. Carbs are welcome — just from whole sources, alongside the rest.",
        "This one shift steadies blood sugar more than any supplement and means fewer cravings, fewer crashes, calmer skin, and over time more regular cycles.",
        "Move in ways that build muscle. Two or three short strength sessions a week improve insulin sensitivity for hours afterward. Add a 10-minute walk after your largest meal.",
        "Long, punishing cardio isn't required and can backfire by raising cortisol. Walking, strength training, yoga, and swimming are PCOS-friendly.",
        "Protect sleep like a prescription. Seven to nine hours, a consistent bedtime, a cool dark room, and a calm wind-down lower the cortisol that worsens PCOS.",
        "Add small, repeatable stress outlets — a daily walk, breathwork, journaling, time outdoors. Five honest minutes a day beats one perfect hour a week.",
        "Layer in supportive supplements only after the basics: inositol, vitamin D, omega-3s, and magnesium are the most evidence-backed for PCOS.",
        "Take the long view. PCOS rewards patience and consistency far more than intensity."
      ]},
    ],
    articles: [
      {
